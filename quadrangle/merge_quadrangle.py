...
def fill_quadrangle(a, b, c, d, degree, delta_upx, delta_upy, delta_downx, delta_downy, angle, cnt):
    gcode = ""
    tri = 0
...
def merge_quadrangle(a, b, c, d, degree, width, shell_width, circle):
    ...
    if angle[0] > math.pi/2 - degree:
        ...
        cnt = 1
        gcode1, na, nb, nc, nd, cnt, tri = fill_quadrangle(nb, nc, nd, na, degree, delta_upx, delta_upy, delta_downx, delta_downy, newangle, cnt)
        #print(na, nb, nc, nd)
        ...
        cnt = 1
        gcode1, na, nb, nc, nd, cnt, tri = fill_quadrangle(na, nb, nc, nd, degree, delta_upx, delta_upy, delta_downx, delta_downy, newangle, cnt)
